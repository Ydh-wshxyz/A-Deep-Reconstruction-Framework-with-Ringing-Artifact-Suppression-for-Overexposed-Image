...
from Dataset import dataset_load_RealImage2, PSF_load
import torch
import numpy as np
...
def test_function(args):
    ...
    # Dataset
    test_data, test_number = dataset_load_RealImage2(args.test_dir, 'mat')  # 测试数据
    ...
    for ind in range(test_number):
        ...
        img_test = test_data[ind].copy() / 65535. * 0.9
